...
|---|---|---|---|---|
| 1 | **N** Data work | 2 | 1 | Data work. Practical; much of it is about failure modes rather than history. |
| 2–3 | **O** Classical ML | 19 | 2 | Classical ML. Large, and needs real sourcing for every named method. |
| 4–5 | **K** Neural networks | 14 | 2 | Neural networks. Dates and papers throughout, so these want seeds, not just prose. |
| 6–7 | **L** AI engineering | 23 | 2 | AI engineering. Fastest-moving material, so the most likely to date badly. |
| 8–11 | **B** System design | 37 | 4 | System design. The largest single track and the heaviest research load. |

**95 lessons across 11 batches.**

---

### Batch 1 — Track N: Data work
...
### Batch 2 — Track O: Classical ML (part 1 of 2)
...
### Batch 3 — Track O: Classical ML (part 2 of 2)
...
### Batch 4 — Track K: Neural networks (part 1 of 2)
...
### Batch 5 — Track K: Neural networks (part 2 of 2)
...
### Batch 6 — Track L: AI engineering (part 1 of 2)
...
### Batch 7 — Track L: AI engineering (part 2 of 2)
...
### Batch 8 — Track B: System design (part 1 of 4)
...
### Batch 9 — Track B: System design (part 2 of 4)
...
### Batch 10 — Track B: System design (part 3 of 4)
...
### Batch 11 — Track B: System design (part 4 of 4)
